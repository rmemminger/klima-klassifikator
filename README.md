...
**Daten:** 
- Input Texte sollten Absatzlänge haben und idealerweise eine Länge von 528 Tokens nicht überschreiten. Zwar ist eine Klassifikation auch bei Überlänge möglich, jedoch schneidet das Embedding Modell den Text nach der Maximallänge ab, wodurch nur die ersten 528 Tokens bei der Klassifikation berücksichtigt werden können. Da der Klassifikator außerdem auf kürzeren Texten (maximal 250 Tokens) trainiert wurde, empfielt sich die Anwendung auf vergleichbare Textlängen. 
